import { Box, Button, Center, FormControl, FormLabel, Input, Stack, useToast } from "@chakra-ui/react";
...
<form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
    ...
    <FormControl spacing={8} marginBottom={4} className="space-y-2">
      ...
      <Input marginLeft={-4}
        ...
        borderColor="transparent" _focus={{ outline: "none", boxShadow: "none", borderColor: "transparent" }}
        _hover={{ outline: "none", boxShadow: "none", borderColor: "transparent" }}
      />
      {errors.photoURL && (
  ...
  <FormControl  spacing={8} marginBottom={4} className="space-y-2">
    ...
    <FormControl className="space-y-2">
      ...
      />
      {errors.email && (
        <span className="text-red-600">Instructor Email is required</span>
      )}
    </FormControl>
  </Stack>
  <Stack direction="row" spacing={8} marginBottom={4}>
